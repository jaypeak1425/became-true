  ...
  return (
    <main>
      <section style={{ padding: '80px 0 60px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '52px', fontWeight: 800, margin: '0 0 20px', letterSpacing: '-1px', lineHeight: 1.1 }}>
          Every missed call is a job walking out the door.
        </h1>
        <p style={{ fontSize: '20px', color: 'rgba(255,255,255,0.75)', maxWidth: '720px', margin: '0 auto 32px', lineHeight: 1.5 }}>
          Became True is an AI receptionist that answers every call 24/7, books the job, and never sends a caller to voicemail. $297/mo. Setup in 48 hours. 30-day money-back guarantee.
        </p>
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="https://buy.stripe.com/fZu7sLfwjgG731f6ij0gw00" style={{ display: 'inline-block', background: '#b8a8ff', color: '#0a0e27', fontWeight: 700, padding: '18px 28px', borderRadius: '10px', textDecoration: 'none', fontSize: '18px' }}>
            Start Now — $297/month
          </a>
          <a href="tel:4690694255" style={{ display: 'inline-block', background: 'transparent', color: '#fff', fontWeight: 600, padding: '18px 28px', borderRadius: '10px', textDecoration: 'none', fontSize: '18px', border: '2px solid rgba(255,255,255,0.25)' }}>
            📞 (469) 069-4255
          </a>
        </div>
        <div style={{ marginTop: '24px', display: 'flex', justifyContent: 'center', gap: '24px', flexWrap: 'wrap', fontSize: '13px', color: 'rgba(255,255,255,0.5)' }}>
      ...
      <section style={{ padding: '60px 0', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '24px', maxWidth: '900px', margin: '0 auto' }}>
          <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '12px', padding: '24px', textAlign: 'left' }}>
